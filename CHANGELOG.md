...
- **SDG:** Allow to add header cards to SDG homepage [\#4367](https://github.com/consul/consul/pull/4367)
...
- **SDG:** Display related SDG and targets on polls and processes [\#4329](https://github.com/consul/consul/pull/4329)
- **SDG:** Improve performance sorting SDG records [\#4342](https://github.com/consul/consul/pull/4342)
- **SDG:** Add targets to SDG view [\#4331](https://github.com/consul/consul/pull/4331)
- **SDG:** Add header section on SDG Goals Index [\#4334](https://github.com/consul/consul/pull/4334)
- **SDG:** Make target filter change when goal filter changes [\#4337](https://github.com/consul/consul/pull/4337)
...
- **SDG:** Add descriptions to SDG view [\#4330](https://github.com/consul/consul/pull/4330)
...
- **SDG:** Allow filtering by local target in SDG management [\#4322](https://github.com/consul/consul/pull/4322)
- **SDG:** Add related list selector component to forms [\#4325](https://github.com/consul/consul/pull/4325), [\#4386](https://github.com/consul/consul/pull/4386) and [\#4336](https://github.com/consul/consul/pull/4336)
- **SDG:** Add SDG goal/target selector [\#4315](https://github.com/consul/consul/pull/4315), [\#4358](https://github.com/consul/consul/pull/4358) and [\#4327](https://github.com/consul/consul/pull/4327)
- **SDG:** Add SDG cards management section [\#4311](https://github.com/consul/consul/pull/4311) and [\#4310](https://github.com/consul/consul/pull/4310)
...
- **SDG:** Add SDG view with related content [\#4292](https://github.com/consul/consul/pull/4292), [\#4309](https://github.com/consul/consul/pull/4309) and [\#4320](https://github.com/consul/consul/pull/4320)
- **SDG:** Style SDG headers following UN guidelines [\#4298](https://github.com/consul/consul/pull/4298) and [\#4304](https://github.com/consul/consul/pull/4304)
- **SDG:** Add SDG filters to advanced search [\#4300](https://github.com/consul/consul/pull/4300)
- **SDG:** Add SDG icons to related records [\#4305](https://github.com/consul/consul/pull/4305) and [\#4343](https://github.com/consul/consul/pull/4343)
...
- **SDG:** Add SDG content management section [\#4269](https://github.com/consul/consul/pull/4269) and [\#4294](https://github.com/consul/consul/pull/4294)
...
- **SDG:** Add SDG settings [\#4247](https://github.com/consul/consul/pull/4247)
...
- **Maintenance**: Use Pronto to check code conventions [\#4382](https://github.com/consul/consul/pull/4382), [\#4388](https://github.com/consul/consul/pull/4388) and [\#4385](https://github.com/consul/consul/pull/4385)
...
- **Maintenance-Refactoring:** Refactor participatory budgets in draft mode [\#4369](https://github.com/consul/consul/pull/4369)
...
- **Maintenance-Gems:** Bump knapsack_pro from 1.15.0 to 2.6.0 [\#4148](https://github.com/consul/consul/pull/4148)
